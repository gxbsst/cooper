...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG.md", "README.markdown", "MIT-LICENSE", "lib/routing/filter.rb", "lib/routing_filter/chain.rb", "lib/routing_filter/filters/locale.rb", "lib/routing_filter/filters/uuid.rb", "lib/routing_filter/filters/pagination.rb", "lib/routing_filter/filters/extension.rb", "lib/routing_filter/version.rb", "lib/routing_filter/filter.rb", "lib/routing_filter/adapters/rails_3.rb", "lib/routing_filter/adapters/routers/journey.rb", "lib/routing_filter/adapters/routers/rack_mount.rb", "lib/routing_filter/adapters/rails_2.rb", "lib/routing_filter.rb", "lib/routing-filter.rb"]
